; ============================================================
; Clinica Dental Pro - Custom NSIS Installer Script
...
!macro customWelcomePage
  !define MUI_WELCOMEPAGE_TITLE "Bienvenido a Clinica Dental Pro"
  !define MUI_WELCOMEPAGE_TEXT "Este asistente le guiara a traves de la instalacion de Clinica Dental Pro.$\r$\n$\r$\nSistema de Gestion de Historias Clinicas Dentales.$\r$\n$\r$\nDesarrollado por Charles-X RedFlame Systems.$\r$\n$\r$\nPresione Siguiente para continuar."
...
!macro customFinishPage
  ...
  !define MUI_FINISHPAGE_TEXT "Clinica Dental Pro ha sido instalado correctamente.$\r$\n$\r$\nPresione Finalizar para cerrar el asistente."
  !define MUI_FINISHPAGE_RUN
  !define MUI_FINISHPAGE_RUN_TEXT "Ejecutar Clinica Dental Pro"
...
!macro customInstall
  ${ifNot} ${isUpdated}
    ...
    File /oname=ClinicaDentalProSetup.bat "${PROJECT_DIR}\scripts\ClinicaDentalProSetup.bat"
    ...
    nsExec::ExecToLog '"$sysdir\cmd.exe" /C "$PLUGINSDIR\ClinicaDentalProSetup.bat" "$INSTDIR"'
...
!macro customUnWelcomePage
  !define MUI_WELCOMEPAGE_TITLE "Desinstalar Clinica Dental Pro"
  !define MUI_WELCOMEPAGE_TEXT "Este asistente eliminara Clinica Dental Pro de su sistema.$\r$\n$\r$\nSus datos clinicos NO seran eliminados a menos que lo seleccione.$\r$\n$\r$\nPresione Siguiente para continuar."
